...
import static com.cd.ruileda.cc.view.widget.ShapeView.Shape.Square;
import static com.cd.ruileda.cc.view.widget.ShapeView.Shape.Triangle;

/**
 * Created by hcDarren on 2017/7/22.
 * 58 加载数据动画
 */
...
public class LoadingView extends LinearLayout{
    ...
    private void initAnimator() {
        ...
        // 动画作用在谁的身上
        // 下落位移动画
        translationAnimator = ObjectAnimator.ofFloat(mShapeView,"translationY",mTranslationDistance,0);
        //translationAnimator.setDuration(ANIMATOR_DURATION);
        // 配合中间阴影缩小
        scaleAnimator = ObjectAnimator.ofFloat(mShadowView,"scaleX",0.3f,1f);
        //scaleAnimator.setDuration(ANIMATOR_DURATION);
